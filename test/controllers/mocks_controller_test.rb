...
class MocksControllerTest < ActionController::TestCase
  ...
  test "should create mock" do
    assert_difference('Mock.count') do
      post :create, mock: { description: @mock.description, name: @mock.name, project_id: @mock.project_id, requirement_id: @mock.requirement_id, url: @mock.url }
    end
  ...
  test "should update mock" do
    patch :update, id: @mock, mock: { description: @mock.description, name: @mock.name, project_id: @mock.project_id, requirement_id: @mock.requirement_id, url: @mock.url }
    assert_redirected_to mock_path(assigns(:mock))
  end
